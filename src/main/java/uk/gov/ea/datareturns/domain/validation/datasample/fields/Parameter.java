...
public class Parameter extends AbstractAliasingEntityValue<uk.gov.ea.datareturns.domain.jpa.entities.masterdata.impl.Parameter> {
    ...
    @NotBlank(message = DataSampleFieldMessageMap.Missing.Parameter)
    @ControlledList(auditor = ParameterAuditorNew.class, message = DataSampleFieldMessageMap.ControlledList.Parameter)
