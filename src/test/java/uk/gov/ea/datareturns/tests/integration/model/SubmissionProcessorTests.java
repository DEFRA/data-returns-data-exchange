...
public class SubmissionProcessorTests {
    ...
    public void testSingleSuccessfulSubmission() throws IOException {
        List<DataSample> samples = submissionProcessor.parse(readTestFile(SINGLE_SUCCESSFUL_SUBMISSION));
    ...
    public void testMultipleSuccessfulSubmission() throws IOException {
        List<DataSample> samples = submissionProcessor.parse(readTestFile(MULTIPLE_SUCCESSFUL_SUBMISSION));
        Assert.assertNotNull(samples);
    ...
    public void testSingleFailureSubmission() throws IOException {
        List<DataSample> samples = submissionProcessor.parse(readTestFile(SINGLE_FAILURE_SUBMISSION));
        Assert.assertNotNull(samples);
        ValidationErrors validationErrors = submissionProcessor.validate(samples);
    ...
    public void testMultipleFailureSubmission() throws IOException {
        List<DataSample> samples = submissionProcessor.parse(readTestFile(MULTIPLE_FAILURE_SUBMISSION));
