...
cd ${base_dir} > /dev/null
mvn -Dcheckstyle.skip=true -Ddependency-check.skip=true -DskipTests=true \
    sql:execute@drop-database sql:execute@create-database liquibase:update exec:java@load-data
